...
export class ReinitDB1658339289634 implements MigrationInterface {
    name = 'ReinitDB1658339289634'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tag" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "title" character varying(56) NOT NULL DEFAULT '', "isMeta" boolean NOT NULL DEFAULT false, "level" integer NOT NULL, "parentId" uuid, "authorId" uuid NOT NULL, CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`);
